...
class PromptLearner(nn.Module):
    ...
    def reset_classnames(self, classnames, arch):
        ...
        # loading quilt weights to clip arch
        ckpt_quilt = torch.load("/l/users/asif.hanif/pre-trained-models/quiltnet/quiltnet_b32/quiltnet_b32.pt")
        clip.load_state_dict(ckpt_quilt, strict = False)
